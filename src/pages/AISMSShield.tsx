...
const AISMSShield = () => {
  // AI Chatbot state (preserved from original)
  ...
  // Capacitor placeholder: READ_SMS permission
  // In production, use Capacitor plugin: @nicoara/capacitor-sms-inbox
  // Deno.Capacitor?.Plugins?.SmsInbox?.requestPermission()
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto max-w-4xl flex flex-col">
        ...
        <Tabs defaultValue="sms-scan" className="flex-1 flex flex-col">
          ...
          {/* AI Chatbot Tab (preserved from original) */}
